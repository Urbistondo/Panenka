...
# See importlib._setup() for what is injected into the panenka namespace.

# When editing this code be aware that code executed at import time CANNOT
# reference any injected objects! This includes not only panenka code but also
...
def _lock_unlock_module(name):
    """Release the panenka import lock, and acquires then release the
