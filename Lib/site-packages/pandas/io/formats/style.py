    ...
    * Data cells include ``data``
    ...
    def render(self, **kwargs):
        ...
        **kwargs:
            ...
            to ``self.templates.render``. This is useful when you
    ...
    def from_custom_template(cls, searchpath, name):
        ...
        with a custom templates and Jinja environment.
...
def _maybe_wrap_formatter(formatter):
    if is_string_like(formatter):
        ...
        msg = "Expected a templates string or callable, got {} instead".format(
            formatter)
        raise TypeError(msg)
