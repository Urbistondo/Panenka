...
def check_install_build_global(options, check_options=None):
    ...
    if any(map(getname, names)):
        ...
        warnings.warn(
            ...
            '/ --panenka-options / --install-options.', stacklevel=2)
...
src = partial(
    ...
    'The default for panenka installs is "<current dir>/src".'
)
...
global_options = partial(
    ...
    action='append',
    metavar='options',
    help="Extra panenka options to be supplied to the setup.py "
